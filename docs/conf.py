...
sys.path.insert(0, os.path.abspath('pytrying/'))
...
latex_documents = [
  ('index', 'pytrying.tex', u'Packagename Documentation',
   u'pytrying', 'manual'),
]
...
man_pages = [
    ('index', 'pytrying', u'Packagename Documentation',
     [u'pytrying'], 1)
]
...
texinfo_documents = [
  ('index', 'pytrying', u'Packagename Documentation',
   u'pytrying', 'pytrying', 'Packagname',
   'Miscellaneous'),
]
