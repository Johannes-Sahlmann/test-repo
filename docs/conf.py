...
sys.path.insert(0, os.path.abspath('testrepo/'))
...
latex_documents = [
  ('index', 'testrepo.tex', u'testrepo Documentation',
   u'testrepo', 'manual'),
]
...
man_pages = [
    ('index', 'testrepo', u'testrepo Documentation',
     [u'testrepo'], 1)
]
...
texinfo_documents = [
  ('index', 'testrepo', u'testrepo Documentation',
   u'testrepo', 'testrepo', 'Packagname',
   'Miscellaneous'),
]
